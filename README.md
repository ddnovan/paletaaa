...
Herramienta web interactiva para la generación de paletas de colores estéticas y la verificación de contraste según la normativa **WCAG 2.1**, con simulación de daltonismo en tiempo real.
...
* **Arquitectura:** Patrón Observador (Pub/Sub) + Estado Global.
* **Normativa:** W3C WCAG 2.1 (Luminancia Relativa).
...
Este repositorio forma parte de un portafolio personal. Queda prohibida su reproducción, distribución o modificación total o parcial del código sin autorización previa del autor.

**© 2026 Dónovan Martín**. **Todos los derechos reservados**.  